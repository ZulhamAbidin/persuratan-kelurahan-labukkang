                                        ...
                                        <form method="post" action="<?= base_url(); ?>surat/updateStatus/<?= $key['id']; ?>">
                                            <div class="modal-body text-center">
                                                ...
                                                <div class="radio">
                                                 ...
                                                 <label for="status">Pilih Tanda Tangan</label>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="ttd" value="0" <?= $key['ttd'] == '0' ? 'checked="true"' : '' ?>><span class="circle"></span><span class="check"></span> <?= $ttd['0'] ?>
                                                    </label>
                                                   
                                                    <label>
                                                        <input type="radio" name="ttd" value="1" <?= $key['ttd'] == '1' ? 'checked="true"' : '' ?>><span class="circle"></span><span class="check"></span> <?= $ttd['1'] ?>
                                                    </label>
                                                </div>
                                            </div>

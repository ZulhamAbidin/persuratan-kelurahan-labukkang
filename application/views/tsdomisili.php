...
<body>
  <div class="logo">
    ...
    <div class="container">
        ...
        <p class="font-normal text-underline text-center font-bold headline">SURAT KETERANGAN DOMISILI</p>
        ...
        <p class="footer-text"><span class="margin-text">Bahwa </span>nama tersebut di atas adalah benar-benar warga
            kami sebagaimana berdomisili di Kelurahan Labukkang, Kecamatan Ujung, Kota Parepare</p>

        <p class="footer-text"><span class="margin-text">Demikian </span>Surat Keterangan Domisili ini dibuat dengan
        ...
        <table class="margin-top-24">
            ...
            <tr>
                <td class="width-footer"></td>
                <td >   <img src="<?= base_url() ?>assets/foto/barcode.png" height="60" alt="Barcode"></td>
            </tr>
            <tr>
                <td class="width-footer"></td>

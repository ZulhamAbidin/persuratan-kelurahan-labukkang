...
<div class="logo">
    ...
    <header class="header-surat">
        ...
        <p class="footer-text text-justify"><span class="margin-text">Pihak </span>pertama telah benar-benar
            ...
            Tanah/Perumahan kepada pihak kedua. Dengan NOP. …………….Dengan luas…. M2 yang terletak di Dusun …… Desa
            Kelurahan Labukkang kec. Ujung, Kota PareparePada SPPT …. dengan batas-batas sebagai berikut : </p>
        ...
        <table class="margin-top-24">
            <tbody>
                ...
                <tr>
                    <td class="padding-head">Mengetahui : <br><span class="font-bold">Kelurahan Labukkang</span></td>
                    <td></td>
                    <td class="pad">Labukkang 2024<br><span class="font-bold">Lurah Labukkang</span></td>
                </tr>
                <tr>
                    <td class="text-underline font-bold ">..............</td>
                    <td></td>
                    <td class="text-underline font-bold pad">...............</td>
                </tr>
            </tbody>

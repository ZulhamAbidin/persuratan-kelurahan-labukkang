...
<head>
	...
	<title>LOGIN</title>
	<link rel="icon" type="image/png" href="<?= base_url() ?>/assets/lineone/images/favicon.png" />
	...
	<link href="<?= base_url() ?>/assets/lineone/fonts.googleapis.com/css2aa0e.css?family=Inter:wght@400;500;600;700&amp;family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&amp;display=swap" rel="stylesheet" />
	<script>
